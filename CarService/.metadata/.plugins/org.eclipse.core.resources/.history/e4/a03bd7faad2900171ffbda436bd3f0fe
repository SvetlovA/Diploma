...
<table class="table">
	<tr class="table-row">
		...
		<th class="table-header-cell">State number</th>
	...
	<tr class="table-row">
		<td class="table-cell">${car.getCarGuid()}</td>
		<td class="table-cell">${car.getNumber()}</td>
		<td class="table-cell">${car.getMark()}</td>
		<td class="table-cell">${car.getModel()}</td>
